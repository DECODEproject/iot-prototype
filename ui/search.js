...
var _user$project$Search$uniqueLocations = function (items) {
	return _elm_community$list_extra$List_Extra$unique(
		A2(
			_elm_lang$core$List$map,
			function (x) {
				return x.location.uid;
			},
			items));
};
...
var _user$project$Search$FloatDataItem = F2(
	function (a, b) {
		return {value: a, date: b};
	});
var _user$project$Search$prepareGraphData = function (items) {
	return A2(
			...
			return A2(
				_elm_lang$html$Html$a,
				{
					...
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Search$ViewGraph(item)),
					_1: {
						ctor: '::',
		...
		case 'RequestAccess':
			return A2(
				_elm_lang$html$Html$a,
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Events$onClick(
						_user$project$Search$RequestAccess(item)),
					_1: {
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$href('#'),
						_1: {ctor: '[]'}
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('request access'),
					_1: {ctor: '[]'}
				});
		default:
			return A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('request in progress, try again'),
					_1: {ctor: '[]'}
				});
	}
};
...
if (typeof _user$project$Search$main !== 'undefined') {
    _user$project$Search$main(Elm['Search'], 'Search', undefined);
}
